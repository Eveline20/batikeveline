                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{route('checkout.store', $product->id)}}" class="basic-form" method="POST">
                                ...
                                <div>
                                <div class="mb-4">
                                    <label for="exampleInputEmail" class="form-label">Card Number</label>
                                    <input name ="card_number" type="number" class="form-control" id="exampleInputEmail" aria-desribedby="emailHelp">
                                </div> 
                                <div class="mb-5">
                                <div class="row">
                                <div class="col-lg-6 col-12">
                                    <label for="exampleInputEmail" class="form-label">Expired</label>
                                    <input name ="expired" type="month" class="form-control" id="exampleInputEmail" aria-desribedby="emailHelp">
                                </div> 
                                <div class="col-lg-6 col-12">
                                    <label for="exampleInputEmail" class="form-label">CVC</label>
                                    <input name ="cvc" type="number" class="form-control" maxlength="3" id="exampleInputEmail" aria-desribedby="emailHelp">
                                </div> 
